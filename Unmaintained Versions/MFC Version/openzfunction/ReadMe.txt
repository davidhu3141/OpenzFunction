================================================================================
    MFC 程式庫 : openzfunction 專案概觀
===============================================================================

應用程式精靈已經為您建立了這個 openzfunction 應用程式。這個應用程式
不僅示範了使用 MFC 的基本概念，也是您撰寫應用程式的起點。

這個檔案的內容摘要，包含各個構成 openzfunction 應用程式的檔案。

openzfunction.vcproj
...
openzfunction.h
    ...
    並宣告 CopenzfunctionApp 應用程式類別。

openzfunction.cpp
    這是主要的應用程式原始程式檔，它包含應用程式類別 CopenzfunctionApp。
...
res\openzfunction.ico
    這個圖示檔是用來做為應用程式的圖示。這個圖示包含在主要資源檔
    openzfunction.rc 內。

res\openzfunction.rc2
...
res\Toolbar.bmp
    ...
    openzfunction.rc 的 IDR_MAINFRAME TOOLBAR 陣列，即可
    新增工具列的按鈕。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    這些檔案是用來建置名為 openzfunction.pch 的先行編譯標頭 (PCH) 檔，
